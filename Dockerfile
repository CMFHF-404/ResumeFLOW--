...
ARG VITE_ENABLE_EVIDENCE_RESUME_SCORE
ARG VITE_ENABLE_RESUME_REVIEW_V4
...
ENV VITE_API_BASE_URL=$VITE_API_BASE_URL \
    ...
    VITE_ENABLE_EVIDENCE_RESUME_SCORE=${VITE_ENABLE_EVIDENCE_RESUME_SCORE:-false} \
    VITE_ENABLE_RESUME_REVIEW_V4=${VITE_ENABLE_RESUME_REVIEW_V4:-false} \
