  ...
  const content = (
    <>
      <div className="flex items-center justify-between gap-3 border-b border-slate-200 px-5 py-4">
        <div>
          <h3 className="text-base font-semibold text-slate-900">选择简历</h3>
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[121] hidden items-center justify-center px-4 md:flex">
        <div className="flex h-[72vh] w-full max-w-2xl flex-col overflow-hidden rounded-[28px] bg-white shadow-[0_24px_80px_rgba(15,23,42,0.28)]">
          {content}
        </div>
      </div>

      <div className="fixed inset-0 z-[120] bg-black/35 backdrop-blur-[1px] md:hidden" onClick={onClose} />
      <div className="fixed inset-x-0 bottom-0 z-[121] h-[72vh] rounded-t-[28px] border border-slate-200 bg-white shadow-[0_-24px_60px_rgba(15,23,42,0.22)] md:hidden">
