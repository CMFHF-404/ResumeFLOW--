...
async def create_agent_key(
    ...
    created = await create_agent_api_key(session, current_user.id, payload.name)
...
async def analyze_agent_job(
    ...
    return await build_agent_job_analysis(session, agent_user.id, payload)
...
async def generate_agent_job_resume(
    ...
    analysis = await build_agent_job_analysis(session, agent_user.id, payload)
