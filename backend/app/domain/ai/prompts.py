...
STAR_POLISH = (
    ...
    "using Markdown (**text**) when appropriate. Use only the provided facts; do not "
    "invent anything. Use the same language as the input. Use other fields for "
    ...
    "(e.g. '1. ... 2. ...'), based strictly on provided info. Return JSON only with "
    "keys: 's', 't', 'a', 'r'."
)
...
STAR_POLISH_S = (
    ...
    "(**text**) when appropriate. Use only the provided facts; do not invent "
...
STAR_POLISH_T = (
    ...
    "Markdown (**text**) when appropriate. Use only the provided facts; do not "
...
STAR_POLISH_A = (
    ...
    "quantifiable results using Markdown (**text**) when appropriate. Use only the "
    ...
    "Output an ordered list of concise action points (e.g. '1. ... 2. ...'). Return "
